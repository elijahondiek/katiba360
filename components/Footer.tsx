...
const ComingSoonChip = ({ className = "", variant = "footer" }: { className?: string, variant?: "default" | "footer" }) => {
  // Use green for header (default) and white for footer
  const baseClasses = "inline-flex items-center justify-center px-2 py-0.5 text-xs font-medium rounded-full relative -top-1"
         ...
         <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
             ...
             <ul className="space-y-2">
               ...
               <li>
                 <div className="flex items-center">
                   <span className="text-[#E5E7EB] opacity-70 cursor-not-allowed" aria-disabled="true">
                     {t("nav.learn")}
                   </span>
                   <ComingSoonChip className="ml-1" variant="footer" />
                 </div>
               </li>
             </ul>
           </div>
           ...
           <div>
             ...
             <ul className="space-y-2">
               ...
               <li>
                 <Link href="/about/mission" className="text-[#E5E7EB] hover:text-white">
                   Our Mission
                 </Link>
               </li>
               <li>
                 <Link href="/about/team" className="text-[#E5E7EB] hover:text-white">
                   Team
                 </Link>
               </li>
               <li>
                 <Link href="/about/partners" className="text-[#E5E7EB] hover:text-white">
                   Partners
                 </Link>
               </li>
               <li>
                 <Link href="/about/contact" className="text-[#E5E7EB] hover:text-white">
                   Contact Us
                 </Link>
               </li>
             </ul>
           ...
           <div>
             ...
             <ul className="space-y-2">
               <li>
                 <a 
                   href={process.env.NEXT_PUBLIC_CONTACT_PROFILE_URL || "https://x.com/WebShrewd"} 
                   target="_blank" 
