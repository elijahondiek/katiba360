...
import { ChevronDown, BookOpen, Shield, Gavel, Users, Users2, Landmark, FileText, GraduationCap, Lock, Scale } from "lucide-react"
              ...
              {[
                ...
                <Link href={chapter.href} key={chapter.id}>
                  <div className="bg-[#F3F4F6] hover:bg-[#E5E7EB] rounded-xl p-6 transition-all duration-200 h-full flex flex-col">
                    ...
                    <p className="text-[#6B7280] flex-grow">{chapter.description}</p>
        ...
        <section className="py-12 px-4 bg-[#F9FAFB]">
          <div className="container mx-auto max-w-6xl">
            <div className="text-center mb-10">
              <h2 className="text-3xl font-bold text-[#0A7B24] mb-4">{t("home.commonScenarios")}</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
              ...
              {scenariosData.categories
                ...
                .map(category => (
                  <Link href={`/scenarios?category=${category.id}`} key={category.id}>
                    <div className="border border-[#E5E7EB] hover:border-[#1EB53A] rounded-xl p-6 transition-all duration-200 hover:shadow-md relative">
                      ...
                      <h3 className="text-lg font-bold mb-2 text-[#0A7B24]">{category.title}</h3>
